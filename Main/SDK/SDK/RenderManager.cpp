...
void Render::Initialise()
{
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::ESP2, "Smallest Pixel-7", 11, 120, 0, 0, FONTFLAG_OUTLINE);
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::Tabs, "skeet_tab_font_by_lemon", 30, 600, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::xd, "Verdana", 20, 500, 0, 0, FONTFLAG_NONE);
	Interfaces::Surface->SetFontGlyphSet(Fonts::jew, "Verdana", 30, 530, 0, 0, FONTFLAG_NONE);
...
void Render::drawintrect(IntRect r, Color c)
{
	Interfaces::Surface->DrawSetColor(c);
	Interfaces::Surface->DrawFilledRect(r.x0, r.y0, r.x0 + r.w, r.y0 + r.h);
}

void Render::DrawFilledQuadOneSided(Vector2D p0, Vector2D p1, Vector2D p2, Vector2D p3, Color c)
{
	Vertex_t verts[4];
	...
	Interfaces::Surface->DrawSetColor((byte)c.r(), (byte)c.g(), (byte)c.b(), (byte)c.a());
