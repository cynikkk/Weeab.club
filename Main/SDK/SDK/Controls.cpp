...
void CSlider::Draw(bool hover)
{
	...
	Render::text_yeti(a.x + Location - (txtSize.right / 2), a.y + 8 - (txtSize.bottom / 2), buffer, Render::Fonts::MenuBold, Color(175, 175, 175, 255));

	/*
	
	https://cdn.discordapp.com/attachments/483980505985843200/488539929505169410/FEA2.JPG
	try make this at a later date
